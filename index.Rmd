...
![](./PICS/kf33.png){width=550}

For 1 to K: 1) Build A Model on Combined Training Folds, 2) Make Predictions on Test Fold
and 3) Record Performance Metric (e.g AUC, Accuracy)
...
Note that the capabilities of caret are considerable. We can do pre processing of data
that insulates us from having to do it ourselves. 
